...
#import "PMReachabilityWrapper.h"

NSString *const kPMReachabilityChangedNotification = @"kPMReachabilityChangedNotification";

@interface PMReachabilityWrapper ()
...
@implementation PMReachabilityWrapper
...
{
    return [PMReachabilityWrapper reachabilityWithHostname:hostname];
}
...
-(BOOL)startNotifier
{
    ...
    self.reachabilitySerialQueue = dispatch_queue_create("com.brbulic.reachability", NULL);
...
{
	PMNetworkStatus temp = [self currentReachabilityStatus];
...
-(void)reachabilityChanged:(SCNetworkReachabilityFlags)flags
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [[NSNotificationCenter defaultCenter] postNotificationName:kPMReachabilityChangedNotification
                                                            object:self];
    });
}
